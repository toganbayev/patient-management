package dev.toganbayev.billingservice.grpc;
...
public class BillingGrpcService extends BillingServiceGrpc.BillingServiceImplBase {
    ...
    public void createBillingAccount(BillingRequest billingRequest, StreamObserver<BillingResponse> responseObserver) {
        ...
        // Generate unique billing account ID for each patient
        String billingAccountId = UUID.randomUUID().toString();

        log.info("Created billing account {} for patient {} ({})",
                billingAccountId, billingRequest.getName(), billingRequest.getEmail());
